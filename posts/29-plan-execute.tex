...
\lobsters{https://lobste.rs/s/hub6qd/plan_execute_pattern}
...
}{Scott H. Young, \cite{Get Better at Anything}}
...
impl ExecutionState {
    ...
    /// Indicates that the task corresponding to the node is in progress.
    fn started(&mut self, node: NodeId) { \ldots  }

    /// Indicates that the task corresponding to the node has been completed.

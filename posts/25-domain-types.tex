...
}{John Ousterhout, \cite{A Philosophy of Software Design, Chapter 14}}
...
\epigraph{A constraint on component design leads to freedom and power when putting those components together into systems.}{
  Rúnar Bjarnason, \href{https://www.youtube.com/watch?v=GqmsQeSzMdw}{\cite{Constraints Liberate, Liberties Constrain}}.
}

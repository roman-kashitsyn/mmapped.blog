...
\subtitle{Applying scientific method in software engineering.}
\date{2022-04-01}
\modified{2024-09-26}
...
}{Stephen Jay Gould, \cite{The Mismeasure of Man (Revised \& Expanded), p.178}}
...
}{Enrico Fermi, \href{https://www.atomicarchive.com/resources/documents/trinity/fermi.html}{\cite{My Observations During the Explosion at Trinity on July 16, 1945}}}
...
\epigraph{
    ...
    I say, ``I'm thinking!''
}{Richard Feynman, \cite{Surely You're Joking, Mr. Feynman!}}
...
}{Linus Torvalds, \href{https://lkml.org/lkml/2000/9/6/65}{\cite{Re: Availability of kdb}}}
...
}{Rob Pike, \href{https://www.informit.com/articles/article.aspx?p=1941206}{\cite{The Best Programming Advice I Ever Got}}}

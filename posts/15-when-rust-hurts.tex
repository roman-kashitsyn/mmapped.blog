...
\lobsters{https://lobste.rs/s/pd8rr8/when_rust_hurts}
\date{2023-02-14}
\modified{2023-02-16}
...
}{Alexander Stepanov, \cite{Elements of Programming, p. 5}}
...
}{The Rustonomicon, \href{https://doc.rust-lang.org/nomicon/races.html}{\cite{Data Races and Race Conditions}}}
...
}{Eelco Dolstra, \cite{\href{https://edolstra.github.io/pubs/phd-thesis.pdf}{The Purely Functional Software Deployment Model}, p. 53}}
...
}{Albert Einstein, \cite{\href{https://books.google.ch/books?redir_esc=y&hl=de&id=HvZAAQAAIAAJ&focus=searchwithinvolume&q=spooky+action}{The Born-Einstein letters}, p. 158.}}
...
}{Bob Nystrom, \href{https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function/}{\cite{What Color is Your Function?}}}

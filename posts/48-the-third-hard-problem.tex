...
it's better if things can get assigned multiple places simultaneously.}{David Weinberger, \cite{Everything Is Miscellaneous}}
...
\epigraph{the writer’s goal is to encode a web of ideas into a string of words using a tree of phrases.}{Steven Pinker, \cite{The Sense of Style}}
...
\blockquote{Writing is easy. All you do is stare at a blank sheet of paper until drops of blood form on your forehead.}{Gene Fowler}
...
\epigraph{The units of which an artificial city is made up are always organized to form a tree.}{Christopher Alexander, \cite{A City is not a Tree.}}
...
}{Christopher Alexander, \cite{A City is not a Tree}}
...
}{Jorge Luis Borges, \cite{The Analytical Language of John Wilkins}}

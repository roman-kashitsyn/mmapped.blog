...
Almost all the open positions required knowledge of mysterious things called \sc{unix} and \emph{sockets}.
...
``\href{https://www.goodreads.com/book/show/22066650-unix}{The \sc{unix} Operating System}'' by Andrey Robachevsky et al., also known as the \emph{turtle book} in Russia because of its cover, introduced me to the magical world of \sc{unix}-like operating systems.

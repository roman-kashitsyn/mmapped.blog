...
I am currently involved in the effort to deliver the \href{https://github.com/dfinity/ICRC-1}{\textsc{icrc-1}} fungible token standard for the \href{https://internetcomputer.org}{Internet Computer}.
The two topics the \href{https://forum.dfinity.org/t/announcing-token-standard-as-topic-of-the-first-meeting-of-the-ledger-tokenization-working-group/11925}{Ledger \& Tokenization} working group discussed most heatedly are the use of \href{#subaccounts}{subaccounts} and the core payment flow for smart contracts (in particular, the \code{approve}/\code{transferFrom} flow popularized by the \href{https://eips.ethereum.org/EIPS/eip-20}{\textsc{erc-20}} token standard).
...
}{Neal Stephenson, \cite{The Confusion}}
...
The most prominent examples of fungible tokens in the digital world are digital assets such as \href{https://bitcoin.org/}{Bitcoin}, \href{https://ethereum.org/en/eth/}{Ether}, and \href{https://wiki.internetcomputer.org/wiki/ICP_token}{\textsc{icp}} utility tokens.
...
The IC mints \textsc{icp} utility tokens to reward participants in the network governance and node providers.
...
\begin{tabular}[uniform]{l l l l r}
...
The \textsc{icp} ledger also uses fees as a mechanism for spam prevention.

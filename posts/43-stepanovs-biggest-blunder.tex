...
We'll view a sequence \mathml{\mi{f}} as a function over natural numbers
and denote the discrete derivative of \mathml{\mi{f}} as \mathml{\msub{\mi{D}}{\mi{f}}}
and its antiderivative as \mathml{\msub{\mi{S}}{\mi{f}}}, where
...
\mathml{\msub{\mi{D}}{\mi{f}}} corresponds to differences between adjacent elements in the source sequence,
and \mathml{\msub{\mi{S}}{\mi{f}}} corresponds to partial sums.
...
yielding \mathml{\mi{N}\mo{-}\mn{1}} slopes for a sequence of \mathml{\mi{N}} elements.
...
(where \mathml{\mi{c}} is an arbitrary constant) have the same derivative
...
The lossiness of differentiation is the reason for introducing an \href{https://en.wikipedia.org/wiki/Constant_of_integration}{arbitrary constant} \mathml{\mi{C}}
